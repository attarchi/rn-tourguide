...
const OVERLAY_HEADER_HEIGHT = 120
// Add <TourGuideProvider/> at the root of you app!
function App() {
  return (
    <TourGuideProvider
      scrollViewTopReserved={OVERLAY_HEADER_HEIGHT}
      {...{ borderRadius: 16, androidStatusBarVisible: true }}
    ...
    <>
      <ScrollView
        ...
        contentContainerStyle={{
          flexGrow: 1,
          paddingTop: OVERLAY_HEADER_HEIGHT,
        }}
      ...
      <View style={styles.overlayHeader}>
        <Text style={styles.headerText}>Overlay Header</Text>
      </View>
    </>
  )
}
